...
## CHARM
[CHARM](https://github.com/robkavanagh/charm) is a framework I developed for characterising magnetic fields using Bayesian inference. It applies a sampling algorithm to time series data, extracting probabilistic estimates for key physical parameters encoded in the data. This framework has been implemented into the workflows of international teams, leading to two publications in leading journals.

## MASER
[MASER](https://github.com/robkavanagh/maser) is a tool I developed for forecasting and analysing time series radio data of magnetic interactions between stars and planets. This enables teams to improve their data collection strategies without running computationally expensive simulations. I also recently developed a [web interface](https://maser.robkavanagh.xyz/) for MASER, enabling experts to use it without local install. MASER has been used to analyse time series by multiple international teams, resulting in two publications in leading journals.
